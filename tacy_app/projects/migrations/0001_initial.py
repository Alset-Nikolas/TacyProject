    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('initiative_activate', models.BooleanField(default=True, help_text='Нужно ли выводить метрику в реестре инициатив')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_community_activate', models.BooleanField(default=True, help_text='В сообществе емкость актуальна, например подразделения')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('is_create', models.BooleanField(default=False, help_text='Возможность созданияиния инциативы')),
                ('is_author', models.BooleanField(default=False, help_text='Флаг автора')),
                ('date_create', models.DateField(default=django.utils.timezone.now, verbose_name='Дата создания проекта')),
